...
| [`use-my-browser`](./skills/use-my-browser/README.md)                                                  | Use the user's live browser session when work depends on rendered state, logged-in flows, uploads, media, DOM inspection, or browser-only failures.              | `references/`             |
